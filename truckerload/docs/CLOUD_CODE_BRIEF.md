# TruckerLoad — бриф для Cloud Code / Claude Code
...
**TruckerLoad** (в UI также **Truck Log**) — нативное Android-приложение для дальнобойщиков, которые возят грузы **Amazon Relay**.

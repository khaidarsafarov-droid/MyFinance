...
fun ProfileEditScreen(
    ...
    // Hydrate edit fields once from the loaded profile. Do NOT key on `profile` itself —
    // avatar upload refreshes the Flow and would wipe in-progress location / name edits.

...
/**
 * Expandable manage panel: nickname, search/add friends, share prefs, friend list.
 * (Presented as an inline sheet section under the map preview.)
 */
@Composable
fun FriendsMapBottomSheet(

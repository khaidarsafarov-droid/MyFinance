...
/**
 * Facade over account-scoped social sub-repositories.
 *
 * Call sites keep injecting [SocialRepository]; Phase 3 Step 1 extracts the
 * god-file into Profile / Chat / Group / Status / Media / SyncCoordinator.
 */

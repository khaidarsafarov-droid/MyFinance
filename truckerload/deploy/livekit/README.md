...
| Client URL | `wss://lk.107.170.0.183.sslip.io` |
| Ktor API | `https://107.170.0.183.sslip.io` |
| Health (SFU) | `http://127.0.0.1:7880/` on the droplet, or `https://lk.107.170.0.183.sslip.io/` |
| Ports | TCP 80/443 (Caddy), TCP 7881 (ICE), UDP 7882 (ICE mux). LiveKit signal is local 7880 behind Caddy. |
